...
import { FortuneButton } from "../target/types/fortune_button";
...
describe("fortune-button", () => {
  const provider = anchor.AnchorProvider.env();
  anchor.setProvider(provider);

  const program = anchor.workspace.FortuneButton as Program<FortuneButton>;
  ...
  it("returns fortune index and collects fee to vault", async () => {
