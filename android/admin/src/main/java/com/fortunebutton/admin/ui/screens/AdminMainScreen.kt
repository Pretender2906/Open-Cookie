package com.fortunebutton.admin.ui.screens
...
import com.fortunebutton.admin.domain.model.displayName
import com.fortunebutton.admin.ui.AdminTab
import com.fortunebutton.admin.ui.AdminUiState
import com.fortunebutton.admin.ui.AdminViewModel
import com.fortunebutton.admin.ui.components.AdminTabChip
import com.fortunebutton.admin.ui.theme.AdminBackground
...
fun AdminMainScreen(viewModel: AdminViewModel) {
    ...
    AdminBackground {
        Scaffold(
            ...
            topBar = {
                TopAppBar(
                    title = { Text("Fortune Button Admin") },
